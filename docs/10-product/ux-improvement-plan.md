...
Recent Profile management, favorites/pinning/tags/search, result moving/deletion/comparison, final-run summary redesign, broad Profile/current-test visual redesign, autosave/recovery and batch/queue execution remain outside S8-B1 and unstarted. Exact milestone status and implementation slicing belong only to the [roadmap](../00-project/roadmap.md) and [work plan](../00-project/work-plan.md).
