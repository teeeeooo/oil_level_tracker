...
- Active S11-R2 Foam/Spatial authority repair: [`20-architecture/s11-foam-spatial-authority-repair-architecture.md`](20-architecture/s11-foam-spatial-authority-repair-architecture.md)
...
- Active S11-R2 detector validation: [`30-validation/s11-foam-spatial-authority-repair-validation.md`](30-validation/s11-foam-spatial-authority-repair-validation.md)
