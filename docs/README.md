...
- Active S11-R13 replacement architecture: [`20-architecture/s11-r13-phase-identity-recovery-architecture.md`](20-architecture/s11-r13-phase-identity-recovery-architecture.md)
- Active S11-R13 validation contract: [`30-validation/s11-r13-phase-identity-recovery-validation.md`](30-validation/s11-r13-phase-identity-recovery-validation.md)
