...
- Current S12 UI/UX contract: [`10-product/ux-improvement-plan.md`](10-product/ux-improvement-plan.md)
- Current S12 Result Review contract: [`10-product/result-review-viewer-plan.md`](10-product/result-review-viewer-plan.md)
- S12 local information-architecture evidence: [`60-evidence/s12/s12-ui-information-architecture-refresh.md`](60-evidence/s12/s12-ui-information-architecture-refresh.md)
...
- Current S11-R16 replacement candidate architecture: [`20-architecture/s11-r16-directed-tracklet-material-lifecycle-architecture.md`](20-architecture/s11-r16-directed-tracklet-material-lifecycle-architecture.md)
- Current S11-R16 validation contract: [`30-validation/s11-r16-directed-tracklet-material-lifecycle-validation.md`](30-validation/s11-r16-directed-tracklet-material-lifecycle-validation.md)
- S11-R16 pushed local-completion evidence pending private-Windows field replay: [`60-evidence/s11/s11-r16-directed-tracklet-material-lifecycle.md`](60-evidence/s11/s11-r16-directed-tracklet-material-lifecycle.md)
...
- S11-R15 field-authority architecture: [`20-architecture/s11-r15-state-aware-material-ownership-architecture.md`](20-architecture/s11-r15-state-aware-material-ownership-architecture.md)
- S11-R15 field-authority validation contract: [`30-validation/s11-r15-state-aware-material-ownership-validation.md`](30-validation/s11-r15-state-aware-material-ownership-validation.md)
