...
- Validating S11-R6 optics-aware observation architecture: [`20-architecture/s11-r6-optics-aware-observation-architecture.md`](20-architecture/s11-r6-optics-aware-observation-architecture.md)
- S11-R6 validation contract: [`30-validation/s11-r6-optics-aware-observation-validation.md`](30-validation/s11-r6-optics-aware-observation-validation.md)
