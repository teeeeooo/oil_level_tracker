...
- Active S11-R4 field-residual authority architecture: [`20-architecture/s11-r4-field-residual-authority-architecture.md`](20-architecture/s11-r4-field-residual-authority-architecture.md)
- Active S11-R4 validation: [`30-validation/s11-r4-field-residual-authority-validation.md`](30-validation/s11-r4-field-residual-authority-validation.md)
