...
S5-B remains evidence-preserving and fail-closed: raw observations form bounded proposals, proposals form semantic hypotheses, a typed current observation is validated by the canonical evidence graph, and only an accepted canonical boundary may enter the serialized reducer and public projection.
