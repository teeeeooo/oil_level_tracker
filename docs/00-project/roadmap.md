...
- **Status:** `ACTIVE`
- **Major result:** S11-A probing rejected unsafe scalar relative-phase recovery; P2, its genuine FULL/EMPTY preservation correction and conservative Spatial fallback are accepted production behavior, while offline trajectory interpolation remains rejected. Local-corpus portability is repaired and Windows canonical re-validation is green. Controlled field re-validation nevertheless still shows near-total BASE ambiguity despite visually clear Oil, and the frozen 68-frame blind comparison shows sample-dependent Oil recall/localization plus unresolved Foam/Oil separation. No detector/general-field accuracy PASS or S11 completion is inferred.
- **Next gate:** S11-C full-video production replay on the four Mac local videos followed by bounded visual/candidate forensic attribution; generated bundles remain ignored temporary evidence. Use the result to choose the smallest responsible S11-D repair owner rather than a global threshold change.
- **Priority:** `P0`
- **Detail:** [S11 real-field detector effectiveness plan](../30-quality/s11-real-field-detector-effectiveness-plan.md), [S11-C full-video forensic diagnostic](../30-quality/s11-c-full-video-production-replay-visual-forensic-diagnostic.md), [S11-A detector direction and experiment plan](../30-quality/s11-a-detector-direction-and-experiment-plan.md), [S11-B Spatial production fallback](../30-quality/s11-b-spatial-positive-evidence-production.md), [S11 Offline Temporal Trajectory probe](../30-quality/s11-offline-temporal-trajectory-probe.md)
