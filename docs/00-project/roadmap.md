...
- **Status:** `ACTIVE`
- **Major result:** S11-A/B repairs are accepted, Windows canonical is green, and S11-C full-video replay/visual forensics is complete. S11-C reproduces the field ambiguity class locally, separates sample3 candidate-generation from identifiability failures, proves Spatial is both necessary for valid sample2 recovery and risky in some full-like sample3 scenes, and establishes a causal structural/refractive Foam-context → Oil-routing defect on sample4. No detector/general-field accuracy PASS or S11 completion is inferred.
- **Next gate:** S11-D1 provisional Lane C repair of structural/refractive Foam discrimination and Oil context safety, preceded by a bounded reference review and followed by four-video replay. Keep sample3 positive-evidence recovery as a separate S11-D2 gate.
- **Priority:** `P0`
