...
- **Status:** `ACTIVE`
- **Major result:** S11-A/B repairs are accepted, Windows canonical is green, S11-C full-video replay/visual forensics is complete, and S11-D1 has been independently audited and merged. D1 preserves S5-A Foam publication while withholding structurally unsafe Foam context from S5-B Oil routing; exact-head four-video replay preserved base/sample2/sample3 behavior, retained the user-confirmed sample2 Spatial recoveries, and removed sample4 structural-context Oil publication without an alternate numeric path. No detector/general-field accuracy PASS or S11 completion is inferred.
- **Next gate:** S11-D2 — bounded sample3 positive-evidence recovery for the separately proven candidate-present/non-identifiable and candidate-not-generated defects, while preserving the accepted D1 Foam/Oil context boundary and Spatial safety constraints.
- **Priority:** `P0`
