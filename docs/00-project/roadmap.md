...
- **Priority:** `P0`
- **Detail:** [S11 real-field detector effectiveness plan](../30-quality/s11-real-field-detector-effectiveness-plan.md), [S11-C full-video forensic diagnostic](../30-quality/s11-c-full-video-production-replay-visual-forensic-diagnostic.md), [S11-D1 Foam/Oil context repair](../30-quality/s11-d1-foam-structural-refractive-discrimination-oil-context-safety.md), [S11-A detector direction and experiment plan](../30-quality/s11-a-detector-direction-and-experiment-plan.md), [S11-B Spatial production fallback](../30-quality/s11-b-spatial-positive-evidence-production.md), [S11 Offline Temporal Trajectory probe](../30-quality/s11-offline-temporal-trajectory-probe.md)
