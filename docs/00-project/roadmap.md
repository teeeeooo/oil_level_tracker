...
- **Next gate:** Execute final target-Windows field-workflow validation on the merged post-modularization head; S11 remains open until that evidence is accepted.
- **Priority:** `P0`
