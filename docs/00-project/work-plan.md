...
Run the dedicated **Foam detection/context diagnostic** spanning sample4 false-positive/structural over-detection risk and sample3 blind-visible Foam misses. S11-D3 current-frame semantic authority slimming is accepted and merged through PR #90; its exact-head audit preserved affirmative no-interface, genuine collision, Foam-topology and serialized temporal ownership while recovering five of the 17 diagnosed sample3 current-frame semantic-loss rows. Temporal trajectory work remains downstream of the Foam diagnostic.
