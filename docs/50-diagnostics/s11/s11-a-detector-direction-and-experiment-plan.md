...
> **Completed diagnostic record.** Any “active/current gate” wording below describes the S11-A diagnostic stage at the time. Current authority is [`../../00-project/work-plan.md`](../../00-project/work-plan.md).
...
It supplements [S11 Real-Field Detector Effectiveness Recovery](../../60-evidence/s11/s11-real-field-detector-effectiveness-history.md) and does not replace the S5-B observability contract.
