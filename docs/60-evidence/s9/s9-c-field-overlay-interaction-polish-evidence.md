...
Windows GUI/DPI execution, PyInstaller packaging, detector benchmarks, long-duration/soak validation, unrelated canonical/E2E validation and autosave/recovery are intentionally outside this Worker run. The S9-C Windows/DPI obligations are recorded in [manual GUI and Windows acceptance](../../40-operations/manual-gui-windows-checklist.md).
