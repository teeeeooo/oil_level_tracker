...
### Historical R7–R12 revision procedures

The revision-specific R7–R12 field procedures are archived at [`../90-archive/s11/windows-r7-r12-field-procedures.md`](../90-archive/s11/windows-r7-r12-field-procedures.md). They are historical reconstruction material, not the current execution route.

For the current S11 candidate, use [`s11-current-windows-field-qualification.md`](s11-current-windows-field-qualification.md) together with the current Work Plan and reviewed truth.
