...
This ordering is authoritative domain-owner input for future category-balanced evidence planning. It does not change the global metric or acceptance architecture in the [real-world validation plan](./real-world-validation-plan.md).
