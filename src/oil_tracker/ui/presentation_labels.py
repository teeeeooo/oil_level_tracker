...
VALIDATION_MESSAGE_BY_CODE = {
    ...
    "STRUCT_DUPLICATE_GLASS": "같은 Glass ID가 중복되어 있습니다.",
    "STRUCT_ELLIPSE": "분석 영역 타원이 영상 범위를 벗어나거나 크기가 올바르지 않습니다.",
    ...
    "STRUCT_SCALE": "실제 길이 환산값은 유한한 0보다 큰 값이어야 합니다.",
    "READY_GLASS": "분석에 포함된 Glass가 하나 이상 필요합니다.",
    "READY_ZERO": "기준점을 먼저 설정해 주세요.",
    "READY_ZERO_BOUNDS": "기준점은 분석 영역 타원 안에 있어야 합니다.",
    "WARN_ZERO_EDGE": "기준점이 분석 영역 가장자리에 너무 가깝습니다.",
    "WARN_SCALE": "실제 길이 환산을 사용하지 않아 결과를 px 단위로 표시합니다.",
...
VALIDATION_SHORT_MESSAGE_BY_CODE = {
    ...
    "STRUCT_SCALE": "실제 길이 환산값 수정 필요",
    "WARN_SCALE": "실제 길이 환산값 확인 필요",
