...
def test_bundle_change_clears_active_truth_context_and_markers(qtbot, tmp_path):
    coordinator, viewer = _coordinator(qtbot)
...
def test_truth_window_is_singleton_and_close_cleans_session(qtbot, tmp_path):
    coordinator, viewer = _coordinator(qtbot)
